...
namespace JornadaMilhas.Integration.Test.API
{
    public class OfertaViagem_GET : IClassFixture<JornadaMilhasWebApplicationFactory>
    {
        ...
        [Fact]
        public async Task Recuperar_OfertasViagens_Na_Consulta_Paginada_Ultima_Pagina()
        {
            //Arrange
        ...
        [Fact]
        public async Task Recuperar_OfertasViagens_Na_Consulta_Paginada_Com_Pagina_Inexistente()
        {
            //Arrange
            _app.Context.Database.ExecuteSqlRaw("DELETE FROM OfertasViagem");
        ...
        [Fact]
        public async Task Recuperar_OfertasViagens_Na_Consulta_Paginada_Com_Pagina_Com_Valor_Negativo()
        {
            //Arrange
            _app.Context.Database.ExecuteSqlRaw("DELETE FROM OfertasViagem");
